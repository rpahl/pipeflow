...
[{targets}](https://docs.ropensci.org/targets/) is the most widely used pipeline
toolkit in the R ecosystem. For a detailed comparison and benchmark results,
see the [vs targets vignette](https://rpahl.github.io/pipeflow/articles/v07-vs-targets.html).
