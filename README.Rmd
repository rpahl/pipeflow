...
It can be used in a wide range of data analysis projects, from small exploratory
analyses to large and complex production pipelines.
...
advanced users, such as the ability to dynamically create branches or to let
pipelines modify themselves at runtime.
...
* automatically skip steps that are already up to date (similar to `make`)
* logging
* re-use, modify, extend and/or combine existing pipelines
* can be integrated with R packages, shiny applications or any other R code

### Advanced features

* dynamically create branches by applying same pipeline to multiple datasets
