...
forced_run <- function(x) pip_run(x, lgr = NULL, force = TRUE)
...
mb_pf <- microbenchmark(
  ...
  "pf br=16"  = forced_run(pips_pf[["pf_br=16"]]),
  "pf br=32"  = forced_run(pips_pf[["pf_br=32"]]),
  "pf br=64"  = forced_run(pips_pf[["pf_br=64"]]),
  "pf br=128" = forced_run(pips_pf[["pf_br=128"]])
)
