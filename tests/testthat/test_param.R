...
describe("CategoricalParam class", {
    test_that("value of Categorical param must be a string from the choices", {
        name = "my param"
        choices = c("a", "b", "c")
...
describe("StringParam class", {
    ...
    test_that("param has a customizable label by default set to its name", {
        name = "my string"
        value = "my value"
    ...
    test_that("param has a customizable description, empty by default", {
        name = "my string"
        value = "my value"
...
describe("param_list_to_json", {
    test_that("when transforming param list to json, list names carried over", {
