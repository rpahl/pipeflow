...
test_that("Param is a virtual class",
{
...
test_that("parameter has a customizable description which is empty by default",
{
    name = "my string"
    value = "my value"
...
test_that("value of Boolean must be of length 1",
{
    ...
    expect_equal(new("BooleanParam", name = name, value = "TRUE")@value, TRUE)
    expect_equal(new("BooleanParam", name = name, value = "true")@value, TRUE)
    expect_equal(new("BooleanParam", name = name, value = "FALSE")@value, FALSE)
    expect_equal(new("BooleanParam", name = name, value = "false")@value, FALSE)
    expect_equal(new("BooleanParam", name = name, value = 1)@value, TRUE)
    expect_equal(new("BooleanParam", name = name, value = 0)@value, FALSE)

    expect_error(new("BooleanParam", name = name, value = c(TRUE, FALSE)))
})

test_that("alternative BooleanParam constructor works",
{
    name = "my bool"
...
test_that("value of Categorical parameter must be a string from the choices",
{
    name = "my param"
    choices = c("a", "b", "c")

    f = function(value)
        new("CategoricalParam", name = name, value = value, choices = choices)
...
test_that("alternative NumericParam constructor works",
{
...
test_that("alternative DataframeParam constructor works",
{
    daf = data.frame(x = 1:2, y = 1:2)
...
test_that("alternative ListParam constructor works",
{
    name = "my list"
    value = list(1, 2)
